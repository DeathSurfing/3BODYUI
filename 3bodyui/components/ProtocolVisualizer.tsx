...
import { NetworkLog } from "@/lib/types"
  ...
  return (
    <div className="bg-black border-l border-white w-full lg:w-96 flex flex-col h-full">
      <div className="p-4 border-b border-white flex items-center justify-between">
        <h2 className="font-bold text-[10px] tracking-[0.3em] uppercase">
          Traffic Log
        </h2>
        <span className="text-[10px] border border-white px-2 py-0.5 font-bold animate-pulse">
          LIVE
        </span>
      </div>
